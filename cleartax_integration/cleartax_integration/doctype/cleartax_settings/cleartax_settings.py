...
def retry_failed_pi():
    ...
    for i in pi_list:
            frappe.enqueue("cleartax_integration.cleartax_integration.API.gst.create_gst_invoice",**{'invoice':i.document_name,'type':'PURCHASE'})
...
def retry_faield_si():
    ...
    for i in si_list:
            frappe.enqueue("cleartax_integration.cleartax_integration.API.gst.create_gst_invoice",**{'invoice':i.document_name,'type':'SALE'})
